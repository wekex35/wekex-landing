...
export const CLINIC_AI: Record<string, AiDfyCopy> = {
  hub: {
    ...
    image: "/assets/img/clinic/ai-clinic.webp",
  ...
  crm: {
    ...
    image: "/assets/img/clinic/ai-hospital.webp",
  ...
  booking: {
    ...
    image: "/assets/img/clinic/ai-telehealth.webp",
  ...
  workflows: {
    ...
    image: "/assets/img/clinic/ai-smart-hospital.webp",
  ...
  integrations: {
    ...
    image: "/assets/img/clinic/ai-pharma.webp",
  ...
  pricing: {
    ...
    image: "/assets/img/clinic/ai-personalize.webp",
  ...
  fit: {
    ...
    image: "/assets/img/clinic/ai-health-app.webp",
...
export const PROPERTY_AI: Record<string, AiDfyCopy> = {
  ...
  crm: {
    ...
    image: "/assets/img/property/landing-crm.webp",
  ...
  integrations: {
    ...
    image: "/assets/img/property/ai-square-1.webp",
  ...
  pricing: {
    ...
    image: "/assets/img/property/ai-hub.webp",
  ...
  fit: {
    ...
    image: "/assets/img/property/ai-square-2.webp",
